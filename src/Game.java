...
public class Game extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ImageView double_speed = new ImageView("imgbgr/Menu/Scene/pauseButton.png");
        double_speed.setFitHeight(50);
        double_speed.setFitWidth(50);
        double_speed.setX(1280);
        double_speed.setY(0);
        ImageView double_speed_on_mouse = new ImageView("imgbgr/Menu/Scene/pauseButton.png");
        double_speed_on_mouse.setFitWidth(60);
        double_speed_on_mouse.setFitHeight(60);
        double_speed_on_mouse.setX(1270);
        ...
        root.getChildren().addAll(canvas,item,pauseButton,pauseButton_on_Mouse,double_speed,double_speed_on_mouse); // mới thêm pauseButton và pauseButtonOnMouse
